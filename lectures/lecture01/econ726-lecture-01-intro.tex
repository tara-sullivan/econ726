...
\begin{itemize}
    ...
    \item Challenge yourself to learn at least one causal methodology well (both theoretically and in practice)
    \begin{itemize}
    ...
    \item Communicate results effectively, both in writing and as a presentation
    \item Learn some basic python (or: learn how to engage with code in a language you don't 100\% understand)
\end{itemize}
...
\begin{itemize}
    ...
    \item Consider which paper you would like to base your empirical project on (homework proposing paper ideas due in 2 weeks)
    % \begin{itemize}
...
\begin{itemize}
    \item High-level overview of potential outcomes framework, causal questions
    \item Brief review of methodologies I recommend you use for your paper (diff-in-diff and synthetic control)
\end{itemize}
\end{frame}
