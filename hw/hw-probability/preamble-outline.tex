...
% (C) Define colors
\newcommand{\secc}[1]{{\color{HunterPurple}#1}} % section color
\newcommand{\sectc}{HunterPurple} % section text color
\newcommand{\subsecc}[1]{{\color{HunterPurple}#1}} % subsection color
\newcommand{\subsectc}{HunterPurple} % subsection text color
\newcommand{\numc}{HunterPurple}
