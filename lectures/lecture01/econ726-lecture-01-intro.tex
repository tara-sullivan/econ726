...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Causal Inference on Observational Data}

\textbf{Description:} In real-world settings, analysts and policymakers must draw inferences about causes and effects from observational (non-randomized) data. For example:

\begin{itemize}

\item Does congestion pricing improve traffic in the central business district?
\item Does zoning reform lead to more houses being built?
\item Do speeding cameras make street safer for pedestrians?
...
\begin{itemize}
    \item In plain language, causal inference involves using statistical tools and data to evaluate causal questions
\end{itemize}

% \vspace{2em}
% First: what is a causal question?

% % \begin{itemize}
%     \item Start by discussing causality in an experimental sense, and how that ties to 
% \end{itemize}
...
\begin{itemize}
    \item Understand the central tenants of causal inference
    \item Challenge yourself to learn a causal methodology well (both theoretically and in practice)
    \begin{itemize}
        \item The empirical project is something you should be able to talk about in job interviews
    \end{itemize}
    \item Learn what it means to share runnable code
...
\begin{itemize}
    \item Empirical project: 80\% of final grade


    \vspace{2em}
    \item Homework/quizzes: 10\% of final grade
...
\begin{enumerate}
    ...
    \item Describe and implement some sort of extension to this paper. This could be new and interesting tests for key assumptions, robustness checks, additional results based on other methods or data, replicating results in a different programming language, or combination thereof
\end{enumerate}
...
\textbf{Paper selection}: Due \textbf{September 21} [5\% of final grade]
\begin{itemize}
...
specific question the paper is evaluating. Discuss the data your are using (both your replication data, and data for your extension) Discuss the extensions you are considering, and, if necessary, where you will be getting that data. Verify that you’ve read the paper
\end{itemize} 

\textbf{Replication results}: Due \textbf{November 7}: [10\% of final grade]
\begin{itemize}
...
\item Further, \textbf{unthinking AI usage will be heavily penalized}. If I can tell that you thoughtlessly used an AI, that will result in a zero on your assignment (or that part of your assignment).
...
\begin{itemize}
    \item High-level overview of potential outcomes framework and causal questions
    \item Brief review of methodologies I recommend you use for your paper
\end{itemize}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \miniframesoff
\section[Intro Potential Outcomes]{Introduction to Potential Outcomes Model}
\miniframesoff
\begin{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Na{\"i}ve comparison and selection problem}

In general: Suppose you want to study the impact of a treatment on an outcome:
\begin{itemize}
\item  Clinical example: the treatment could be a drug, and the outcome could be some health outcome
\item Policy example: the treatment could be college attendance,  and the outcome could be future wages
\end{itemize}
% \textbf{Goal:} understand and measure the causal impact of the treatment on the outcome

\vspace{2ex}
One solution: \textbf{na{\"i}ve comparison}
\begin{itemize}
\item  
 Look at people who receive the treatment, and people who do not, and measure differences in the outcome
\item  Average the wages of people who went to college,  and the wages of people who didn't go to college,  and take the difference
\end{itemize}

\vspace{2ex} \textbf{Problem:} people who select to receive the treatment and those who select not to receive the treatment are often different
\begin{itemize}
\item When measuring causal effects,  this leads to \textbf{selection bias}
\item People who select to go to college may be more likely to have higher wages than those who do not,  irrespective of college attendance. 
\end{itemize}

\vspace{2ex}
Helpful framework for formalizing this problem and finding a solution: \textbf{potential outcomes framework}

\end{frame}

\input{potential-outcomes}
